...
class Ui_AdminMenu(object):
    def setupUi(self, AdminMenu):
        ...
        self.gridLayout.addWidget(self.administrate_scenes_button, 0, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.add_questions_button, 2, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.load_custom_fakes_button, 5, 0, 1, 1)
    ...
    def retranslateUi(self, AdminMenu):
        ...
        self.load_custom_fakes_button.setText(_translate("AdminMenu", "Cargar tipos de datos personalizados"))
