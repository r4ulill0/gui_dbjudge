...
class Ui_LoadSqlView(object):
    def setupUi(self, LoadSqlView):
        ...
        self.gridLayout.addWidget(self.confirm_button, 4, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.status_label, 3, 2, 1, 3)
    ...
    def retranslateUi(self, LoadSqlView):
        ...
        self.return_button.setText(_translate("LoadSqlView", "Volver"))
