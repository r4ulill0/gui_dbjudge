...
class Ui_Exam(object):
    def setupUi(self, Exam):
        ...
        self.questions_list = QtWidgets.QScrollArea(self.gridLayoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.questions_list.sizePolicy().hasHeightForWidth())
        self.questions_list.setSizePolicy(sizePolicy)
        self.questions_list.setWidgetResizable(True)
        self.questions_list.setObjectName("questions_list")
        self.scrollAreaWidgetContents = QtWidgets.QWidget()
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 68, 366))
        self.scrollAreaWidgetContents.setObjectName("scrollAreaWidgetContents")
        self.questions_list.setWidget(self.scrollAreaWidgetContents)
        self.gridLayout.addWidget(self.questions_list, 1, 0, 3, 1)
