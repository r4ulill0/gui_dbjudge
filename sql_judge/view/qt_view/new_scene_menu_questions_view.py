...
class Ui_NewSceneMenuQuestions(object):
    def setupUi(self, NewSceneMenuQuestions):
        ...
        self.answer_input = QtWidgets.QPlainTextEdit(self.gridLayoutWidget)
        self.answer_input.setObjectName("answer_input")
        self.gridLayout_2.addWidget(self.answer_input, 2, 6, 1, 2)
        ...
        self.question_input = QtWidgets.QPlainTextEdit(self.gridLayoutWidget)
        self.question_input.setObjectName("question_input")
        self.gridLayout_2.addWidget(self.question_input, 2, 0, 1, 2)
